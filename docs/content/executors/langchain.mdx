...
```bash
ark install marketplace/services/executor-langchain
```
...
- [LangChain Executor README](https://github.com/mckinsey/agents-at-scale-marketplace/tree/main/services/executor-langchain)
