...
The [Filesystem MCP Server](/docs/mcps/filesystem-mcp-server) is designed for small files that can be directly loaded into agent context. For this reason it enforces a **1MB file size** limit for uploads.
