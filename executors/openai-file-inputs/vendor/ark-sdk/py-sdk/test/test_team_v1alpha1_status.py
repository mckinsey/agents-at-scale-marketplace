...
class TestTeamV1alpha1Status(unittest.TestCase):
    """TeamV1alpha1Status unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamV1alpha1Status:
        """Test TeamV1alpha1Status
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamV1alpha1Status`
        """
        model = TeamV1alpha1Status()
        if include_optional:
            return TeamV1alpha1Status(
                conditions = [
    ...
    def testTeamV1alpha1Status(self):
        """Test TeamV1alpha1Status"""
