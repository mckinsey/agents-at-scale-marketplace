...
class ModelV1alpha1SpecConfigAzure(BaseModel):
    ...
    """ # noqa: E501
    api_key: Optional[ModelV1alpha1SpecConfigAzureApiKey] = Field(default=None, alias="apiKey")
    api_version: Optional[MCPServerV1alpha1SpecAddress] = Field(default=None, alias="apiVersion")
    auth: Optional[ModelV1alpha1SpecConfigAzureAuth] = None
    ...
    __properties: ClassVar[List[str]] = ["apiKey", "apiVersion", "auth", "baseUrl", "headers", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiKey": ModelV1alpha1SpecConfigAzureApiKey.from_dict(obj["apiKey"]) if obj.get("apiKey") is not None else None,
            "apiVersion": MCPServerV1alpha1SpecAddress.from_dict(obj["apiVersion"]) if obj.get("apiVersion") is not None else None,
            "auth": ModelV1alpha1SpecConfigAzureAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
