...
class ExecutionEngineV1prealpha1(BaseModel):
    ...
    status: Optional[ExecutionEngineV1prealpha1Status] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": ExecutionEngineV1prealpha1Status.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
