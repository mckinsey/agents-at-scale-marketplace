...
class TestQueryV1alpha1Status(unittest.TestCase):
    """QueryV1alpha1Status unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryV1alpha1Status:
        """Test QueryV1alpha1Status
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryV1alpha1Status`
        """
        model = QueryV1alpha1Status()
        if include_optional:
            return QueryV1alpha1Status(
                conditions = [
    ...
    def testQueryV1alpha1Status(self):
        """Test QueryV1alpha1Status"""
