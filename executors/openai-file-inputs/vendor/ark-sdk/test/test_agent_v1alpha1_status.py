...
class TestAgentV1alpha1Status(unittest.TestCase):
    """AgentV1alpha1Status unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentV1alpha1Status:
        """Test AgentV1alpha1Status
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentV1alpha1Status`
        """
        model = AgentV1alpha1Status()
        if include_optional:
            return AgentV1alpha1Status(
                conditions = [
    ...
    def testAgentV1alpha1Status(self):
        """Test AgentV1alpha1Status"""
