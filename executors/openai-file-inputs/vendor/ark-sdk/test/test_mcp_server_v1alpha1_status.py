...
class TestMCPServerV1alpha1Status(unittest.TestCase):
    """MCPServerV1alpha1Status unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MCPServerV1alpha1Status:
        """Test MCPServerV1alpha1Status
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MCPServerV1alpha1Status`
        """
        model = MCPServerV1alpha1Status()
        if include_optional:
            return MCPServerV1alpha1Status(
                conditions = [
    ...
    def testMCPServerV1alpha1Status(self):
        """Test MCPServerV1alpha1Status"""
